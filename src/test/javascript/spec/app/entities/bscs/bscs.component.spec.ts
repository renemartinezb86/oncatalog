...
import { BSCSComponent } from 'app/entities/bscs/bscs.component';
import { BSCSService } from 'app/entities/bscs/bscs.service';
import { BSCS } from 'app/shared/model/bscs.model';

describe('Component Tests', () => {
    describe('BSCS Management Component', () => {
        let comp: BSCSComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(BSCSComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.bSCS[0]).toEqual(jasmine.objectContaining({ id: '123' }));
        });
