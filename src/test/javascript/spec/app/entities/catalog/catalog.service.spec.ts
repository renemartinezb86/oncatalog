...
describe('Service Tests', () => {
    describe('Catalog Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(CatalogService);
            httpMock = injector.get(HttpTestingController);
            currentDate = moment();

            elemDefault = new Catalog('ID', 'AAAAAAA', 'AAAAAAA', currentDate);
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should return a list of Catalog', async () => {
                const returnedFromService = Object.assign(
                    {
                        name: 'BBBBBB',
                        fileName: 'BBBBBB',
