...
import { PoServiceComponent } from 'app/entities/po-service/po-service.component';
...
describe('Component Tests', () => {
    describe('PoService Management Component', () => {
        let comp: PoServiceComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(PoServiceComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.poServices[0]).toEqual(jasmine.objectContaining({ id: '123' }));
        });
