...
export class BSCSComponent implements OnInit, OnDestroy {
    ...
    registerChangeInBSCS() {
        this.eventSubscriber = this.eventManager.subscribe('bSCSListModification', response => this.loadAll());
    }
    ...
    protected paginateBSCS(data: IBSCS[], headers: HttpHeaders) {
